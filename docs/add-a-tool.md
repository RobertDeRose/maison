...
Only add a package to Nix when system activation or a privileged service depends on it. With an active overlay, these
commands edit and lock the overlay repository; without one, they use the public fallback files.
