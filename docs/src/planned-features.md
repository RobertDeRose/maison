...
| `maison-018-cross-platform-bootstrap-integration` | MAISON-018: Cross-platform consumer bootstrap integration | `maison-mol-90l`  | Planned       | `maison-017-maison-terroir-repository-split`    | [design](features/maison-018-cross-platform-bootstrap-integration/design.md) |
